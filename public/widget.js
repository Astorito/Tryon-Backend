"use strict";(()=>{var f=(t,o,n)=>new Promise((r,e)=>{var i=a=>{try{s(n.next(a))}catch(d){e(d)}},l=a=>{try{s(n.throw(a))}catch(d){e(d)}},s=a=>a.done?r(a.value):Promise.resolve(a.value).then(i,l);s((n=n.apply(t,o)).next())});function E(t){let o=document.createElement("button");return o.id="tryon-floating-button",o.className="tryon-btn-floating",o.setAttribute("aria-label","Open Tryon Widget"),o.title="Try on clothes with your photo",o.innerHTML=`
  ...
  `,i.appendChild(l),i.appendChild(s.component);let a=document.createElement("div");if(a.className="tryon-step-navigation",o>0){let d=document.createElement("button");d.className="tryon-btn-secondary",d.textContent="Back",d.addEventListener("click",()=>n(o-1)),a.appendChild(d)}if(o<t.length-1){let d=document.createElement("button");d.className="tryon-btn-primary",d.textContent="Next",d.addEventListener("click",()=>n(o+1)),a.appendChild(d)}return r.appendChild(e),r.appendChild(i),r.appendChild(a),r}function x(t,o,n,r=["image/*"],e=!1,i=!1){let l=document.createElement("div");l.className=`tryon-dropzone ${e?"compact":""} ${i?"large":""}`;let s=document.createElement("input");s.type="file",s.accept=r.join(","),s.style.display="none";let a=document.createElement("div");a.className="tryon-dropzone-area",i?a.innerHTML=`
  ...
  `,t}function $(){let t=document.createElement("div");t.className="tryon-step-result";let o=L();if(o){t.innerHTML=`
    ...
    `;return t}function j(t){let o=document.createElement("div");o.className="tryon-onboarding";let n=[{title:"Upload Your Photo",subtitle:"Show us what you look like",component:I(),index:0},{title:"Add Your Clothes",subtitle:"Drag up to 4 clothing items",component:M(),index:1},{title:"Generate Try-On",subtitle:"Create your virtual try-on",component:O(),index:2},{title:"See Your Result",subtitle:"Check out how you look",component:$(),index:3}],r=0,e=k(n,r,l=>{r=l,i()});o.appendChild(e);function i(){let l=n[r];e.style.opacity="0",setTimeout(()=>{e.innerHTML="";let s=k(n,r,a=>{r=a,i()});if(e.appendChild(s.firstChild),e.style.opacity="1",r===n.length-1){let a=document.createElement("button");a.className="tryon-btn-primary tryon-btn-onboarding-complete",a.textContent="Start Using Tryon!",a.addEventListener("click",t),e.appendChild(a)}},300)}return i(),o}function P(t){let o=document.createElement("div");o.className="tryon-image-result-container";let n=document.createElement("div");n.className="tryon-image-wrapper";let r=document.createElement("img");r.src=t,r.alt="Generated try-on result",r.className="tryon-result-image";let e=document.createElement("div");e.className="tryon-magnifier-lens";let i=document.createElement("div");i.className="tryon-magnifier-view",i.innerHTML=`<img src="${t}" alt="Magnified view" />`,n.appendChild(r),n.appendChild(e),o.appendChild(n),o.appendChild(i);let l=!1;n.addEventListener("mouseenter",()=>{l=!0,e.style.display="block",i.style.display="block"}),n.addEventListener("mouseleave",()=>{l=!1,e.style.display="none",i.style.display="none"}),n.addEventListener("mousemove",a=>{if(!l)return;let d=n.getBoundingClientRect(),c=a.clientX-d.left,m=a.clientY-d.top;e.style.left=c-50+"px",e.style.top=m-50+"px";let p=2;i.style.backgroundPosition=`-${c*p-150}px -${m*p-150}px`});let s=document.createElement("button");return s.className="tryon-btn-primary tryon-btn-download-result",s.textContent="Download Result",s.addEventListener("click",()=>{let a=document.createElement("a");a.href=t,a.download="tryon-result.png",a.click()}),o.appendChild(s),o}function D(){let t=window.TRYON_WIDGET_CONFIG;if(!t)throw new Error("Tryon Widget config not initialized");return t}function B(t,o){return f(this,null,function*(){let n=D(),r=o.filter(e=>e&&e.length>0);if(!t)throw new Error("User image is required");if(r.length===0)throw new Error("At least one clothing item is required");try{let e=yield fetch(`${n.apiUrl}/generate-widget`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({userPhotoBase64:t,clothingBase64:r[0],apiKey:n.apiKey})});if(!e.ok){let l=yield e.json().catch(()=>({}));throw new Error(l.error||`API error: ${e.status}`)}let i=yield e.json();if(!i.success)throw new Error(i.error||"Generation failed");return{url:i.url,generationId:i.generationId}}catch(e){throw console.error("Try-on generation error:",e),e}})}function H(){let t=document.createElement("div");t.className="tryon-main-ui";let o=document.createElement("div");o.className="tryon-main-header",o.innerHTML=`
    <div class="tryon-logo-badge">TryOn Virtual</div>
  `;let n=document.createElement("div");n.className="tryon-user-photo-section";let r=x("","Upload your Picture",p=>{v(p)},["image/jpeg","image/png","image/webp"],!1,!0);n.appendChild(r);let e=document.createElement("div");e.className="tryon-products-label",e.textContent="Drag the products";let i=document.createElement("div");i.className="tryon-clothes-grid-main";let l=C();for(let p=0;p<3;p++){let y=document.createElement("div");y.className="tryon-clothes-slot-main";let u=x("","",h=>{w(p,h)},["image/jpeg","image/png","image/webp"],!0,!1);if(y.appendChild(u),l[p]){let h=document.createElement("div");h.className="tryon-clothes-preview-main has-image",h.innerHTML=`<img src="${l[p]}" alt="Clothing ${p+1}" />`,y.appendChild(h)}i.appendChild(y)}let s=document.createElement("button");s.className="tryon-btn-create",s.textContent="Create",s.id="tryon-generate-btn",s.addEventListener("click",()=>f(this,null,function*(){yield m()}));let a=document.createElement("div");a.className="tryon-footer",a.innerHTML=`
    <span class="tryon-footer-text">powered by TryOn.site</span>
    <div class="tryon-footer-logo">
      <span>TryOn</span>
    </div>
  `;let d=document.createElement("div");d.className="tryon-section tryon-section-result",d.id="tryon-result-section",t.appendChild(o),t.appendChild(n),t.appendChild(e),t.appendChild(i),t.appendChild(s),t.appendChild(a),t.appendChild(d);function c(){}function m(){return f(this,null,function*(){let p=localStorage.getItem("tryon-user-photo"),y=JSON.parse(localStorage.getItem("tryon-clothes")||"[]");if(!p){alert("Please upload your photo first");return}if(y.filter(u=>u).length===0){alert("Please add at least one clothing item");return}try{s.disabled=!0,s.textContent="Generating...",s.innerHTML='<span class="tryon-spinner"></span> Generating...';let u=yield B(p,y);T(u.url);let h=d;h.innerHTML="",h.appendChild(P(u.url))}catch(u){alert("Error generating image: "+u.message)}finally{s.disabled=!1,s.textContent="Generate Try-On"}})}return t}function U(t){let o=document.createElement("div");o.id="tryon-modal",o.className="tryon-modal tryon-modal-popover";let n=document.createElement("div");n.className="tryon-modal-wrapper tryon-modal-popover-wrapper";let r=document.createElement("button");r.className="tryon-modal-close",r.innerHTML="&times;",r.setAttribute("aria-label","Close modal");let e=document.createElement("div");e.className="tryon-modal-content",n.appendChild(r),n.appendChild(e),o.appendChild(n);let i=!1,l="main";function s(){if(e.innerHTML="",l==="onboarding"){let c=j(()=>{S(!0),l="main",s()});e.appendChild(c)}else{let c=H();e.appendChild(c)}}function a(){i=!0,o.classList.add("tryon-modal-open"),z()?l="main":l="onboarding",s()}function d(){i=!1,o.classList.remove("tryon-modal-open"),e.innerHTML="",t==null||t()}return r.addEventListener("click",d),o.open=a,o.close=d,o}function G(){return`
/* ============================================================================
